...
Partial Public Class BudgetDataSet
    ...
    Partial Public Class IncomeDataTable
        ...
        Private columnIncomeAmount As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public ReadOnly Property IncomeAmountColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnIncomeAmount
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddIncomeRow(ByVal IncomeName As String, ByVal IncomeAmount As Decimal) As IncomeRow
            Dim rowIncomeRow As IncomeRow = CType(Me.NewRow,IncomeRow)
            Dim columnValuesArray() As Object = New Object() {IncomeName, IncomeAmount}
        ...
        Friend Sub InitVars()
            ...
            Me.columnIncomeAmount = MyBase.Columns("IncomeAmount")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnIncomeAmount = New Global.System.Data.DataColumn("IncomeAmount", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnIncomeAmount)
            Me.columnIncomeName.AllowDBNull = false
            Me.columnIncomeName.MaxLength = 2147483647
            Me.columnIncomeAmount.AllowDBNull = false
        End Sub
    ...
    Partial Public Class IncomeRow
        ...
        Public Property IncomeAmount() As Decimal
            Get
                Return CType(Me(Me.tableIncome.IncomeAmountColumn),Decimal)
            End Get
            Set
                Me(Me.tableIncome.IncomeAmountColumn) = value
            End Set
        End Property
    End Class
...
Namespace BudgetDataSetTableAdapters
    ...
    Partial Public Class IncomeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Income] ([IncomeName], [IncomeAmount]) VALUES (@IncomeName, @I"& _ 
                "ncomeAmount)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IncomeAmount", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 2, 0, "IncomeAmount", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Rowe_Brandon_Final_Project_CPT_206.My.MySettings.Default.BudgetConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT IncomeName, IncomeAmount FROM dbo.Income"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As BudgetDataSet.IncomeDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As BudgetDataSet.IncomeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As BudgetDataSet.IncomeDataTable = New BudgetDataSet.IncomeDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As BudgetDataSet.IncomeDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal IncomeName As String, ByVal IncomeAmount As Decimal) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(1).Value = CType(IncomeAmount,Decimal)
